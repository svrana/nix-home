  ...
  xsession = {
    ...
    windowManager = {
      i3 = {
        ...
        #    "${mod}+q" = "kill";
        #    "${mod}+d" = ''
        #      exec --no-startup-id "rofi -show drun -modi drun,run -eh 2 -padding 16 -show-icons"'';
        #      "${mod}+Tab" = ''
        #        exec --no-startup-id "rofi -show window -eh 2 -padding 16 -show-icons"'';
        ...
        #        "${mod}+a" = "focus parent";
        #        "${mod}+Shift+t" =
        #          "exec --no-startup-id alacritty --class tmux -e tmux attach";
        #          "${mod}+1" = "workspace 1";
        #          "${mod}+2" = "workspace 2";
        #          "${mod}+3" = "workspace 3";
        #          "${mod}+4" = "workspace 4";
        ...
        #            "Mod1+Control+l" =
        #              "exec --no-startup-id $HOME/.local/bin/i3lockwrapper.sh";
        #              "Mod1+Control+t" = "exec --no-startup-id alacritty";
        #              "Mod1+Control+v" = "split horizontal";
        #              "Mod1+Control+h" = "split vertical";
        #              "Mod1+Control+u" =
        #                "exec --no-startup-id $HOME/.local/bin/vol.sh --up";
        #                "Mod1+Control+d" =
        #                  "exec --no-startup-id $HOME/.local/bin/vol.sh --down";
        #                  "Mod1+Control+m" =
        #                    "exec --no-startup-id $HOME/.local/bin/vol.sh --togmute";
        ...
        #                        startup = [
        #                          {
        #                            command = "$HOME/.local/bin/polybar-launch.sh";
        #                            notification = false;
        #                            always = true;
        #                          }
        #                          {
        #                            command = "$HOME/.local/bin/autotiling-launch.sh";
        #                            notification = false;
        #                            always = true;
        #                          }
        #                          {
        ...
        #                            {
        #                              command =
        #                                "dbus-launch /usr/lib/gnome-settings-daemon/gsd-xsettings";
        #                                notification = false;
        #                              }
        #                              {
        #                                command = "insync start --headless";
        #                                notification = false;
        #                              }
        #                              {
        #                                command = "dunst";
        ...
        #                              {
        #                                command =
        #                                  "xautolock -corners '--00' -time 5 -locker $HOME/.local/bin/i3lockwrapper.sh";
        #                                  notification = false;
        #                                }
        #                                {
        #                                  command = "hsetroot -solid '#002b36'";
        #                                  notification = false;
        #                                }
        #                                {
        #                                  command = "unclutter";
        ...
        #                                }
        #                                {
        #                                  command = "autocutsel -fork -selection CLIPBOARD";
        #                                  notification = false;
        #                                }
        #                                {
        #                                  command = "autocutsel -fork -selection PRIMARY";
        #                                  notification = false;
        #                                }
        #                                {
        #                                  command = "$HOME/.local/bin/qutebrowser";
        #                                  notification = false;
        #                                }
        #                                {
        #                                  command = "$HOME/.local/bin/standard-notes";
        #                                  notification = false;
        #                                }
        #                                {
        #                                  command = "slack";
