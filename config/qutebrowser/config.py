...
## Type: QtFont
c.fonts.tabs.selected = '13pt "System San Francisco Display Bold"'
c.fonts.tabs.unselected = '13pt "System San Francisco Display"'
...
config.bind(",l", "spawn --userscript qute-pass-mod --mode gopass")  # login username and password
config.bind(",u", "spawn --userscript qute-pass-mod --mode gopass --username-only --no-insert-mode")
config.bind(",p", "spawn --userscript qute-pass-mod --mode gopass --password-only --no-insert-mode")
...
config.bind('<Ctrl-R>', 'config-cycle content.user_stylesheets "~/Apps/solarized-everything-css/css/solarized-dark/solarized-dark-all-sites.css" "~/Apps/solarized-everything-css/css/solarized-light/solarized-light-all-sites.css" ""')
