...
let
  ...
  rofi-pass = "gopass ls --flat | rofi -dmenu -p site -theme-str 'window {width: 25%; border-color: ${cyan};}' | xargs --no-run-if-empty gopass show -o | wl-copy && notify-send 'Copied to clipboard' && sleep 15 && wl-copy --clear";
